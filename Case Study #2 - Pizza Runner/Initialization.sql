...
-- Inserting data into `runner_orders` table
...
-- Inserting data into `pizza_names` table
...
-- Inserting data into `pizza_recipes` table
...
-- Inserting data into `pizza_toppings` table
